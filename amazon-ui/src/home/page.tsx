  ...
  return (
    ...
    <div className='flex flex-col'>
        ...
        <div className=' text-white flex flex-row gap-2 bg-black w-full h-16 p-3 justify-between'>
            ...
            {/* lang */}
            <div className='flex flex-row items-center hover:border border-white'>
             ...
             <div className='flex flex-col text-white hover:border border-white'>
            ...
            <button className='flex flex-row items-end hover:border border-white'>
            ...
            { products.map((product)=>(
                ...
                <div className='flex flex-col w-full '>
                    ...
                    <div className='flex flex-col w-3/4 h-auto '>
                        ...
                        <h1 className='font-semibold'>{product.name}-{product.description}</h1>
                    </div>
                    <div className='w-2/3 '>
                    {/* stars rating */}
                        ...
                        <button className='bg-yellow-400  py-1 w-24 h-8 rounded-2xl text-[14px] mt-2' onClick={() => handleAddToCart(product.id)}> Add to Cart</button>
                    </div>
